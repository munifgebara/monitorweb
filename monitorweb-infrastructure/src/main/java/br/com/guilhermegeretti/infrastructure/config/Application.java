package br.com.guilhermegeretti.infrastructure.config;
...
@Configuration
@ComponentScan(basePackages = {"br.com.guilhermegeretti", "gumga.framework"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBean.class, basePackages = {"br.com.guilhermegeretti", "gumga.framework"})
...
public class Application {
    ...
    public static DataSource dataSource() {
        ...
        config.addDataSourceProperty("url", "jdbc:mysql://localhost:3306/monitorweb?zeroDateTimeBehavior=convertToNull");
...
//        properties.put("hibernate.dialect", "org.hibernate.dialect.H2Dialect");
        ...
        factory.setPackagesToScan("gumga.framework.domain","br.com.guilhermegeretti");
